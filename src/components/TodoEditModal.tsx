...
export default function TodoEditModal({ todo, onClose }: { todo: Todo, onClose?: () => void }) {
    ...
    >
      ...
      >
        ...
        <div className="flex items-start justify-between mb-7">
          <div>
            <p className="text-[10px] uppercase tracking-widest text-zinc-500 mb-1">Editing item #{todo.id}</p>
        ...
        <div className="flex gap-3 mt-6">
          ...
          <button
            ...
            disabled={!title}
            className="flex-[2] py-3 bg-[#7b61ff] text-white rounded-xl text-sm font-bold tracking-wide hover:opacity-90 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[#7b61ff]/20 disabled:opacity-40 disabled:cursor-not-allowed disabled:translate-y-0 transition-all"
          >
            Save Changes ✦
          </button>
        </div>
